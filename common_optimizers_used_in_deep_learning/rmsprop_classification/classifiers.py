import torch
from utils import RMSProp_Scratch
...
class SoftaxRegressionScratch(Classifier):
    ...
    def forward(self, X):
        ...
        # return torch.nn.functional.softmax(torch.matmul(output1, self.W2) + self.b2)
...
class SoftmaxRegression(Classifier):
    ...
    def configure_optimizer(self):
        return torch.optim.RMSprop(self.parameters(), lr=self.lr, alpha=self.beta)