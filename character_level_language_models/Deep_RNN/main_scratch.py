...
from models import StackedRNN, LanguageModel
...
if __name__=="__main__":
    ...
    rnn_model = torch.nn.LSTM(embed_size, hiddens, num_layers=num_blocks)

    # rnn_model = StackedRNN(num_inputs=embed_size, num_hiddens=hiddens, sigma=sigma, num_blocks=num_blocks)
