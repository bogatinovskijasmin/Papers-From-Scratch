...
class EncoderDecoder(Classifier):
    ...
    #     src, tgt, src_valid_lem, _ = batch
    #     enc_all_outputs = self.encoder(src, src_valid_lem)
    #     states = self.decoder.init_states(enc_all_outputs, src_valid_lem)
    #     dec_state = self.decoder.forward(tgt, states)
